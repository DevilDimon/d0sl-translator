  ...
  <node concept="sE7Ow" id="7cwOujT_tlx">
    ...
    <node concept="tnohg" id="7cwOujT_tly" role="tncku">
      <node concept="3clFbS" id="7cwOujT_tlz" role="2VODD2">
        <node concept="3clFbF" id="7cwOujT_Vxd" role="3cqZAp">
          <node concept="2OqwBi" id="7cwOujT_Vxa" role="3clFbG">
            <node concept="10M0yZ" id="7cwOujT_Vxb" role="2Oq$k0">
              <ref role="1PxDUh" to="wyt6:~System" resolve="System" />
              <ref role="3cqZAo" to="wyt6:~System.out" resolve="out" />
            </node>
            <node concept="liA8E" id="7cwOujT_Vxc" role="2OqNvi">
              <ref role="37wK5l" to="guwi:~PrintStream.println(java.lang.String)" resolve="println" />
              <node concept="Xl_RD" id="7cwOujT_VyL" role="37wK5m">
                <property role="Xl_RC" value="It translates!" />
              </node>
            </node>
          </node>
        </node>
        <node concept="3cpWs8" id="7cwOujTAkCp" role="3cqZAp">
          <node concept="3cpWsn" id="7cwOujTAkCs" role="3cpWs9">
            <property role="TrG5h" value="predicate" />
            <node concept="3Tqbb2" id="7cwOujTAkCn" role="1tU5fm" />
            <node concept="33vP2n" id="7cwOujTAkWc" role="33vP2m" />
          </node>
        </node>
      </node>
    </node>
